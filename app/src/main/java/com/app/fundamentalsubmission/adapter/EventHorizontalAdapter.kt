...
import com.app.fundamentalsubmission.databinding.ListEventHorizontalBinding
...
class EventHorizontalAdapter: ListAdapter<ListEventsItem, EventHorizontalAdapter.ViewHolder>(DIFF_CALLBACK) {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ViewHolder {
        return ViewHolder(ListEventHorizontalBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
